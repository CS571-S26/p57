  ...
  return (
    <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-sm overflow-hidden">
      <div className="flex items-center justify-between px-4 py-3 bg-gray-50 dark:bg-gray-900/50 border-b border-gray-200 dark:border-gray-700">
        ...
        <span className={`text-xs font-medium px-2.5 py-0.5 rounded-full ${OCCUPANCY_STYLES[occ]}`}>
          {occ}
        </span>
      </div>
      <div className="px-4 py-3 space-y-1.5 text-sm">
        ...
        <p className="dark:text-gray-300">
          <span className="font-medium text-gray-700 dark:text-gray-400">Direction:</span>{' '}
          {bus.direction}
        </p>
      </div>
    </div>
